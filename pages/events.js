            ...
            <div className="container wide-container">
              ...
              <div className="row valign-wrapper">
                ...
                <div className="col s12 m6 valign order-2">
                  ...
                  <a href="https://www.cvent.com/events/st-john-bosco-conference-july-17-20-2017/registration-fd101066745c42f099a1fade8be9ed1c.aspx?fqp=true%C2%A0" title="Register for the St. John Bosco Conference" target="_blank"><button className="btn waves-effect waves-light btn-inverted">Register</button></a>
                  <a href="https://steubenvilleconferences.com/wp-content/uploads/2016/11/FNL_2017_Conf_Media_inserts_11_Bosco2.pdf" title="St. John Bosco Conference Flyer PDF"><button className="btn waves-effect waves-light btn-inverted" style={{marginLeft: '8px'}}>Flyer</button></a>
                </div>
              </div>
            </div>
          </div>
