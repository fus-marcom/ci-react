...
class TeamCard extends Component {
  ...
  render() {
   ...
   if (this.props.imgUrl !== '') {
     cardImg = `<img src="${this.props.imgUrl}" title="${this.props.name}" style="width: 100px; height: 100px"/>`;
   } else {
    ...
    return (
      <div className="card horizontal hoverable team-card" data-slug={this.props.slug}>
       ...
       <div className="card-stacked" style={{overflowX: 'hidden', whiteSpace: 'nowrap'}}>
